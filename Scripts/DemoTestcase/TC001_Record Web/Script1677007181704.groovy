...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/th_2023'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/span_1975'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/span_Jun'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Contoh demo')
